export const data = {
  funny: {
    truth: [
      'Posral/pochcal si se někdy po svých 10 letech?',
      'Měl si někdy chuť dát pěsti někomu z místnosti?',
      'Prdnul sis v této místnosti během večera?',
      'S kým z místnosti by ses nejradši šel vysrat?',
      'Strkal sis někdy do prdele prst?',
      'Zkoušel si někdy nějakou tvrdou drogu?',
    ...
    dare: [
      ...
      "Napiš 10. člověku ve zprávách: 'Líbil jsem se ti vůbec někdy?'",
      'Zavolej své mamě a řekni, že ses ztratil a tipni to.',
      'Kdo si první prdne, tak ti udělá úkol.',
      'Udělej recenzi na záchod a postni to veřejně na sociální média.',
  ...
  sexistic: {
    truth: [
      'Masturboval si někdy na školních záchodech?',
      'Koho ze spoluhráčů bys chtěl vidět nahého?',
      'Kdyby sis mohl vyspat s jedním z učitelů na tvé škole, kdo by to byl? A proč?',
      'Je člověk, který se ti líbí v této místnosti?',
      'Spal (vrrrr) si s nějakým hráčem z této místnosti?',
      'Měl si někdo sexuální fantazie o někom z této místnosti?',
